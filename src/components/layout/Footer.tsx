...
export default function Footer() {
  return (
    <footer className="bg-zinc-50 dark:bg-background-dark text-zinc-900 dark:text-white border-t border-zinc-200 dark:border-zinc-900 pt-32 pb-16 relative overflow-hidden">

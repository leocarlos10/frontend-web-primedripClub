...
export default function ProductFormDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-zinc-900 border-b border-neutral-200 dark:border-zinc-800 px-6 py-4 flex items-center justify-between z-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2 bg-neutral-50 dark:bg-zinc-800 border cursor-pointer ${
                  errors.categoriaId
                    ? "border-red-500"
                    : "border-neutral-200 dark:border-zinc-700"

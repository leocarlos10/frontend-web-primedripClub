      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="text-center py-20">
          ...
          {onRetry && (
            <button
              onClick={onRetry}
              className="px-8 py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 
              text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 dark:hover:bg-zinc-100 

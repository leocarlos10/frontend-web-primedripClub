        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="flex-1 space-y-10">
              {items.map((item, idx) => (
                <BlurFade key={item.id} delay={0.2 + idx * 0.07} inView>
                  <div className="flex gap-8 pb-10 border-b border-zinc-200 dark:border-zinc-800">
                    {/* Imagen del producto */}
              ...
              {/* Seguir comprando */}
              <BlurFade delay={0.25 + items.length * 0.07}>
                <div className="pt-6">
                  <Link
                    to="/catalogo"
